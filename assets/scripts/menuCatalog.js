const menuCatalog = {
  mainDishes: {
    fishDishes: [
      ...
      {
        Name: "East Blue Seebarsch-Filet 🐟",
        Beschreibung:
    ...
    meatDishes: [
      {
        Name: "Baratie Black-Pepper Steak 🥩",
        Beschreibung:
      ...
      {
        Name: "Water 7 Schiffswerft-Ribs 🛠️🍖",
        Beschreibung:
      ...
      {
        Name: "Wano Kohlegrill-Yakitori-Set 🍢",
        Beschreibung:
      ...
      {
        Name: "Dressrosa Kolosseums-Roulade 🎭🥩",
        Beschreibung:
  ...
  desserts :{
     dessertsCake : [
        {
          Name: "Whole Cake Island Mille-Feuille 🎂",
          Beschreibung: "Knuspriger Blätterteig in hauchdünnen Schichten, Vanillecrème, Meersalz-Karamell-Glasur.",
        ...
        {
          Name: "Baratie Zitrus-Cheesecake 🍰",
          Beschreibung: "Cremiger Käsekuchen mit Yuzu- und Zitronenzeste, knuspriger Keksboden, Blaubeerspiegel.",
          Lore: "In der Baratie serviert Sanji ihn Reisenden gegen Seekater – Zitrus erfrischt, Herz beruhigt.",
          Berry: "6.900"
        },
        {
          Name: "Skypia Wolken-Biskuit ☁️🍰",
          Beschreibung: "Ultra-luftiger Biskuit mit Kokosmilch, Wolkensahne und knusprigen Kokoschips.",
          Lore: "Inspiriert von den Himmelsmeeren; Sanji wollte ein Dessert, das so leicht ist wie eine Luftinsel.",
          Berry: "7.200"
        },
        {
          Name: "Wano Matcha-Kastella 🍵",
          Beschreibung: "Saftiger Kastenkuchen mit feinem Matcha, Sesamkrokant und einem Hauch Anko.",
          Lore: "In Wano verfeinerte Sanji die Kastella-Technik – schlicht, präzise, voller Umami-Süße.",
          Berry: "8.400"
        },
        {
          Name: "Zou Karotten-Nuss-Kuchen 🥕🐰",
          Beschreibung: "Würziger Carrot Cake mit Walnüssen, Zimt und Frischkäse-Frosting, Orangenzeste obenauf.",
       ...
       dessertsSorbet : [
        {
          ...
          Beschreibung: "Frisches Zitronen–Grapefruit-Sorbet mit Dattelwürfeln und Minze; leicht salzige Brise.",
        ...
        {
          Name: "Punk Hazard Frostfeuer ❄️🔥",
          Beschreibung: "Erdbeere–Limette mit einem Hauch Chili; eiskalt serviert, warmer Nachklang.",
          Lore: "Von den geteilten Klimazonen inspiriert: Sanji wollte ein Dessert, das Kälte und Wärme in einem Löffel vereint.",
          Berry: "6.700"
        },
        {
          Name: "Fischmenscheninsel Seesalz–Litschi 🌊🥥",
          Beschreibung: "Litschi–Kokoswasser-Sorbet, verfeinert mit Meersalzflocken und Limettenabrieb.",
          Lore: "In den Korallenstraßen lernte Sanji, wie eine Prise Seesalz die Süße hebt – ein Gruß an die Tiefe.",
          Berry: "6.300"
        },
        {
          Name: "Drum Island Schneeblüten–Kirsche ❄️🍒",
          Beschreibung: "Samtiges Kirschsorbet mit zarten Schnee-Kristallchips und Sakura-Duft.",
          Lore: "Nach Wintermärschen auf Drum Island servierte Sanji etwas, das Zunge und Stimmung taut.",
          Berry: "7.100"
        },
        {
          Name: "Wano Yuzu–Shiso 🍊🌿",
          Beschreibung: "Spritzige Yuzu mit fein gehacktem Shiso, knackig-eisig, kräuterfrisch.",
